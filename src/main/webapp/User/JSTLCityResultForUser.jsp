...
<body>
		...
		<div class="row" id="clusters">
			...
			<div class="col-12 col-lg-6 mb-3 order-lg-1">
				<div class="card" id="covid-content">
					...
					<div class="card-body">
						<p>${sumOfTotalCase}peopleare so far affected in India by
							novel coronavirus covid-19. ${sumOfRecovery} out of
							...
							Covid19India.org after aggregating from various district and
							state level health bulletins and other reliable sources.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
			...
			<div class="col-12 mb-3">
				<ul class="nav nav-pills nav-fill" id="myTab" role="tablist">
					<li class="nav-item"><a class="nav-link active"
						id="state-data-tab" data-toggle="tab" href="#city-data" role="tab"
						aria-controls="state wise data" aria-selected="true">City-wise
							Data</a></li>
				</ul>
			</div>
		</div>
		...
		<a href="paginationOfDistrict?startPage=0&itemPerPage=5"
			style="text-decoration: none;">District Wise / </a> <a
