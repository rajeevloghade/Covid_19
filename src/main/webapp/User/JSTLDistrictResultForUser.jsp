...
<body>
				...
				<tbody>
					<tr>
						...
						<td class="text-center"><a
							href="searchStateForUser?code=${district.state.code}" style="text-decoration: none;">${district.state.stateName}</a></td>
						...
						<td class="text-center"><a
							href="getAllCityByDistrictIdForUser?startPage=0&itemPerPage=5&districtid_fk=${district.code}" style="text-decoration: none;">Cities</a></td>
					</tr>
				</tbody>
			</jstl:forEach>
		</table>
	...
	<div class="container">
		...
		%>
		<a href="paginationOfState?startPage=0&itemPerPage=5" style="text-decoration: none;">State Wise</a> <br>
